...
ward_housing_cost = alt.Chart(df_ward).mark_bar().encode(
    ...
    alt.Y('avg_housing_cost_ward:Q', title = 'rating of housing cost', scale=alt.Scale(domain=(0, 5))
...
ward_streets_sidewalks = alt.Chart(df_ward).mark_bar().encode(
    alt.X('Ward:N', axis=alt.Axis(format='d')),
    alt.Y('avg_streets_sidewalks_ward:Q', title = 'rating of maintenance of streets/sidewalks', scale=alt.Scale(domain=(0, 5))
...
ward_safe_night = alt.Chart(df_ward).mark_bar().encode(
    alt.X('Ward:N', axis=alt.Axis(format='d')),
    alt.Y('avg_safe_night_ward:Q', title = 'How safe do you feel at night?', scale=alt.Scale(domain=(0, 10))
...
ward_beauty = alt.Chart(df_ward).mark_bar().encode(
    alt.X('Ward:N', axis=alt.Axis(format='d')),
    alt.Y('avg_neighborhood_beauty_ward:Q', title = 'Rating of neighborhood beauty', scale=alt.Scale(domain=(0, 10))
